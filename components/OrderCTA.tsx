      ...
      <div className="relative z-10 max-w-4xl mx-auto">
        ...
        >
          ...
          <p className="text-gray-300 text-lg mb-8 text-center max-w-2xl mx-auto">
            Join the waitlist. Pre-order now. Pure beef. Pure gains. Pure simplicity.
          </p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="bg-meathead-black/50 border border-meathead-red/20 rounded-lg p-4">
              <p className="text-gray-400 text-xs leading-relaxed">
                By submitting this pre-order, you consent to us contacting you on WhatsApp for order confirmation and delivery updates.
              </p>
            </div>
