      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-3 gap-8 mb-8">
          ...
          <div className="text-center">
            ...
            {/* WhatsApp link hidden during launch waitlist phase */}
            {/* <a
              href="https://wa.me/923354818171"
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-white transition-colors duration-300 inline-flex items-center justify-center gap-2 mb-2"
            >
              <svg
                className="w-5 h-5"
                fill="currentColor"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="text-gray-300 hover:text-white transition-colors duration-300 inline-flex items-center justify-center gap-2 mb-4"
            >
              <svg
                className="w-5 h-5"
                fill="currentColor"
            ...
            <div className="mt-4 pt-4 border-t border-meathead-gray/30">
              <p className="text-gray-400 text-xs mb-2 font-data">LAUNCHING IN</p>
              <p className="text-gray-300 text-sm">
                Twin City (Islamabad/Rawalpindi)
              </p>
