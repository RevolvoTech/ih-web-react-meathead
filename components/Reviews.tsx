...
const reviews = [
  {
    ...
    response: "Bear season is open, Hassan. See you next Friday for the double patty.",
    rotation: "-rotate-1",
  ...
  },
  {
    ...
    response: "Merge request accepted. Deployment to your stomach is scheduled for Friday 19:00.",
    rotation: "rotate-1",
